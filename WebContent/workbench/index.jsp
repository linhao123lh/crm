...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#updatePwdBtn").click(function(){
			...
			if(oldPwd != null && oldPwd != loginPwd){
				alert("旧密码输入错误!");
				return;
			}
			...
			if(oldPwd != null && newPwd != null && newPwd == loginPwd){
				alert("新密码不能和旧密码一样!");
				return;
			}
			...
			//发送ajax请求
			$.ajax({
				url:"settings/qx/user/modifyPwd.do",
				async:false,
				data:{
					newPwd:newPwd
				},
